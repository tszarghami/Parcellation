function [MB] = spm_mb_ui_mod(action,varargin)
% This is a minimally MODIFIED version of spm_mb_ui.m in SPM12
...
switch lower(action)
    ...
    case 'specify'
        ...
        XYZ    = XYZ(:,logical(F > 1));
        R      = spm_get_data(SPM.VResMS,XYZ); % computation order swapped with Y
        cd("..\attention\functional") % I added
        ...
        %==================================================================
        [J,K,VAR]   = spm_dcm_J_mod(Y,U,X0,SPM.xY.RT,R,I,OPT.d); % VAR added
